...
(function($){
  ...
  theme.Product = (function() {
    ...
    Product.prototype = $.extend({}, Product.prototype, {
      ...
      setCurrentVariantAvailability: function(variant) {
        ...
        availableVariants = Object.assign({}, {variant}, availableVariants);
  ...
  theme.ProductSlider = (function() {
    ...
    function ProductSlider(container) {
      var $container = this.$container = $(container);
      var sectionId = $container.attr('data-section-id');
      var wrapper = this.wrapper = '.grid-overflow-wrapper';
      var slider = this.slider = '#ProductSlider-' + sectionId;
      var $slider = $(slider);
    ...
    ProductSlider.prototype = $.extend({}, ProductSlider.prototype, {
      onUnload: function() {
      ...
      onBlockSelect: function(evt) {
        // Ignore the cloned version
        var $slide = $('.product-slide--' + evt.detail.blockId + ':not(.slick-cloned)');
        var slideIndex = $slide.data('slick-index');
  ...
  $(document).ready(function() {
    ...
    sections.register('product-template', theme.Product);
    sections.register('product-slider', theme.ProductSlider);
...
})(theme.jQuery);function productSlider(){
